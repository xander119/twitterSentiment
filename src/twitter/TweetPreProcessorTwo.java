 ...
 */
public class TweetPreProcessorTwo {
...
//        System.out.println(EmojiParser.parseToAliases(tweetsFromDB.get(0).getText()));
    ...
    public void preProcessingSaveToP1() {
        //1. get data sets
...
//        String pathname = "./data/trainingTwo.arff";
        ...
        String selectTweets = "SELECT c.* from tweet_set_two as c order by c.tweet_id; ";
...
//            text = breakWordsInHashtags(text).replaceAll("\\p{Punct}", "");
        ...
        try {
            ...
            insertTweet = connection.prepareStatement("INSERT INTO tweet_set_two_processed1" +
                    "(tweet_id," +
                    "labelled_sentiment, " +
...
*/
    ...
    public void replaceEmojisFromP1SaveToP2() {
        ...
        try {
            PreparedStatement insertTweet = null;
            insertTweet = connection.prepareStatement("INSERT INTO tweet_set_two_processed2" +
                    "(tweet_id," +
                    "labelled_sentiment, " +
                    "airline_sentiment_confidence," +
                    "negativereason," +
...
//            text = this.expandTweetSlang(text).toLowerCase();
        ...
        try {
            PreparedStatement insertTweet = null;
            System.out.println("map.size: " + map.size());
            insertTweet = connection.prepareStatement("INSERT INTO tweet_set_two_processed3" +
                    "(tweet_id," +
                    "labelled_sentiment, " +
                    "airline_sentiment_confidence," +
                    "negativereason," +
